<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="调休编号" prop="diaoxiubianhao">
            <el-input v-model="ruleForm.diaoxiubianhao" 
                placeholder="调休编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.diaoxiubianhao" label="调休编号" prop="diaoxiubianhao">
              <el-input v-model="ruleForm.diaoxiubianhao" 
                placeholder="调休编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="调休缘由" prop="diaoxiuyuanyou">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="调休缘由"
                  v-model="ruleForm.diaoxiuyuanyou" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.diaoxiuyuanyou" label="调休缘由" prop="diaoxiuyuanyou">
                    <span>{{ruleForm.diaoxiuyuanyou}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	diaoxiubianhao : false,
	riqi : false,
	gonghao : false,
	xingming : false,
	shouji : false,
	diaoxiuyuanyou : false,
	sfsh : false,
	shhf : false,
      },
      ruleForm: {
        diaoxiubianhao: this.getUUID(),
        riqi: '',
        gonghao: '',
        xingming: '',
        shouji: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='diaoxiubianhao'){
            this.ruleForm.diaoxiubianhao = obj[o];
	    this.ro.diaoxiubianhao = true;
            continue;
          }
          if(o=='riqi'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='diaoxiuyuanyou'){
            this.ruleForm.diaoxiuyuanyou = obj[o];
	    this.ro.diaoxiuyuanyou = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `diaoxiushenqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.diaoxiushenqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
