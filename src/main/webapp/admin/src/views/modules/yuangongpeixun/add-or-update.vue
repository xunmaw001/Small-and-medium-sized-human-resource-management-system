  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="周期" prop="zhouqi">
              <el-input v-model="ruleForm.zhouqi" 
                placeholder="周期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="讲师" prop="jiangshi">
          <el-input v-model="ruleForm.jiangshi" 
              placeholder="讲师" clearable  :readonly="ro.jiangshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="讲师" prop="jiangshi">
              <el-input v-model="ruleForm.jiangshi" 
                placeholder="讲师" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="教学反馈" prop="jiaoxuefankui">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jiaoxuefankui" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoxuefankui" label="教学反馈" prop="jiaoxuefankui">
                    <span v-html="ruleForm.jiaoxuefankui"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kecheng = true;
          ...
          if(o=='jiaoxuefankui'){
            this.ruleForm.jiaoxuefankui = obj[o];
	    this.ro.jiaoxuefankui = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.jiaoxuefankui = this.ruleForm.jiaoxuefankui.replace(reg,'../../../ssm1g489/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
