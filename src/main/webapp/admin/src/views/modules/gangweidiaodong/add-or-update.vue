<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入职时间" prop="ruzhishijian">
          <el-input v-model="ruleForm.ruzhishijian" 
              placeholder="入职时间" clearable  :readonly="ro.ruzhishijian"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="原职薪资" prop="yuanzhixinzi">
          <el-input v-model="ruleForm.yuanzhixinzi" 
              placeholder="原职薪资" clearable  :readonly="ro.yuanzhixinzi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="原职薪资" prop="yuanzhixinzi">
              <el-input v-model="ruleForm.yuanzhixinzi" 
                placeholder="原职薪资" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="调入部门" prop="diaorubumen">
          <el-input v-model="ruleForm.diaorubumen" 
              placeholder="调入部门" clearable  :readonly="ro.diaorubumen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="调入部门" prop="diaorubumen">
              <el-input v-model="ruleForm.diaorubumen" 
                placeholder="调入部门" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="调入岗位" prop="diaorugangwei">
          <el-input v-model="ruleForm.diaorugangwei" 
              placeholder="调入岗位" clearable  :readonly="ro.diaorugangwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="调入岗位" prop="diaorugangwei">
              <el-input v-model="ruleForm.diaorugangwei" 
                placeholder="调入岗位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="生效日期" prop="shengxiaoriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shengxiaoriqi" label="生效日期" prop="shengxiaoriqi">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="调动说明" prop="diaodongshuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="调动说明"
                  v-model="ruleForm.diaodongshuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.diaodongshuoming" label="调动说明" prop="diaodongshuoming">
                    <span>{{ruleForm.diaodongshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.ruzhishijian = true;
          ...
          if(o=='yuanzhixinzi'){
            this.ruleForm.yuanzhixinzi = obj[o];
	    this.ro.yuanzhixinzi = true;
            continue;
          }
          if(o=='diaorubumen'){
            this.ruleForm.diaorubumen = obj[o];
	    this.ro.diaorubumen = true;
            continue;
          }
          if(o=='diaorugangwei'){
            this.ruleForm.diaorugangwei = obj[o];
	    this.ro.diaorugangwei = true;
            continue;
          }
          if(o=='diaodongshuoming'){
            this.ruleForm.diaodongshuoming = obj[o];
	    this.ro.diaodongshuoming = true;
            continue;
          }
          if(o=='shenqingriqi'){
    ...
    gonghaoChange () {
      this.$http({
        url: `follow/yuangongxinxi/gonghao?columnValue=`+ this.ruleForm.gonghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              ...
              if(data.data.ruzhishijian){
                this.ruleForm.ruzhishijian = data.data.ruzhishijian
              }
        } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `gangweidiaodong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.gangweidiaodongCrossAddOrUpdateFlag = false;
                  this.parent.search();
