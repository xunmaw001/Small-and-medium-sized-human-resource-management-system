<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="上级" prop="shangji">
          <el-input v-model="ruleForm.shangji" 
              placeholder="上级" clearable  :readonly="ro.shangji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="上级" prop="shangji">
              <el-input v-model="ruleForm.shangji" 
                placeholder="上级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhiwei = true;
          ...
          if(o=='shangji'){
            this.ruleForm.shangji = obj[o];
	    this.ro.shangji = true;
            continue;
          }
          if(o=='bangongdidian'){
