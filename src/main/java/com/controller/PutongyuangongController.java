...
public class PutongyuangongController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		PutongyuangongEntity user = putongyuangongService.selectOne(new EntityWrapper<PutongyuangongEntity>().eq("gonghao", username));
    ...
    public R register(@RequestBody PutongyuangongEntity putongyuangong){
    	...
    	PutongyuangongEntity user = putongyuangongService.selectOne(new EntityWrapper<PutongyuangongEntity>().eq("gonghao", putongyuangong.getGonghao()));
		if(user!=null) {
